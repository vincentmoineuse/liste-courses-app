...
# =========================================================
# CATÉGORIES (uniquement pour l'affichage / organisation UI)
# =========================================================
...
# Sécurité : vérifie qu'aucune recette n'est oubliée / mal orthographiée
_categorized = {r for recs in categories.values() for r in recs}
_missing = set(recipes.keys()) - _categorized
if _missing:
    st.warning(f"⚠️ Recettes non catégorisées : {', '.join(_missing)}")
...
# =========================================================
# QUANTITÉS RECETTES (regroupées par catégorie)
# =========================================================
...
for category_name, recipe_list in categories.items():
...
with st.expander("Modifier les prix unitaires", expanded=False):
